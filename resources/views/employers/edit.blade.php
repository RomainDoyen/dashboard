      ...
      <div class="app-card-body">
        <form class="settings-form" method="POST" action="{{route('employer.update', $employer->id)}}">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="setting-input-2" placeholder="Entrer le prénom" name="prenom" value="{{$employer->prenom}}" required>
            @error('prenom')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer l'email" value="{{$employer->email}}" name="email">
            @error('email')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le contact" value="{{$employer->contact}}" name="contact">
            @error('contact')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="setting-input-3" placeholder="Entrer le montant journalier" name="montant_journalier" value="{{$employer->montant_journalier}}">
